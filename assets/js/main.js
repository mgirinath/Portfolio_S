...
function answerQuestion(question) {
  ...
  if (/hello|hi|hey|vanakkam/.test(q)) return "Hi! Ask me about Girinath's education, skills, projects, internships, certifications, achievements or contact details.";
